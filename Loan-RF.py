...
train = pd.read_csv('/home/muthu/Data-Analytics/Muthu/Loan/train.csv')
test = pd.read_csv('/home/muthu/Data-Analytics/Muthu/Loan/test.csv')
print ("Starting...")
...
test.to_csv('/home/muthu/Data-Analytics/Muthu/Loan/output/sub.csv',columns=['Loan_ID','Loan_Status'],index=False)
